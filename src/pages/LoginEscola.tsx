...
const LoginEscola = () => {
  ...
  const { user, schoolUser, tenant, loading: authLoading, signIn, isAuthenticated } = useSchoolAuth();
  ...
  // Redirect if already authenticated as school user
  useEffect(() => {
      ...
      >
        ...
        <div className="relative bg-gradient-to-br from-pink-50/90 via-white/95 to-violet-50/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/60 p-8 md:p-10">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Portal da Escola</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div className="space-y-2">
              ...
              <Input 
                ...
                className={`h-12 bg-white/80 border-gray-200 rounded-xl focus:ring-2 focus:ring-violet-400 focus:border-violet-400 ${errors.email ? "border-red-400" : ""}`}
                disabled={loading} 
                autoComplete="email" 
              />
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input 
                  ...
                  className={`h-12 bg-white/80 border-gray-200 rounded-xl focus:ring-2 focus:ring-violet-400 focus:border-violet-400 pr-12 ${errors.password ? "border-red-400" : ""}`}
                  disabled={loading} 
