...
import { Plus, Pencil, Trash2, Users, Calendar, Clock, GraduationCap, Archive, ChevronRight } from "lucide-react";
    ...
    <DashboardLayout>
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <nav className="flex items-center gap-2 text-sm">
          ...
          <span className="font-medium text-foreground">{t("classes.title")}</span>
        </nav>

        {/* Header */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-foreground">{t("classes.title")}</h1>
