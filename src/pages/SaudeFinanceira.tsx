...
import { Loader2, ChevronRight, Activity, Target, AlertCircle, Lightbulb, BarChart3 } from "lucide-react";
    ...
    <FinancialLayout>
      <PremiumGate feature="financialHealth">
        <div className="max-w-6xl mx-auto space-y-6">
          ...
          {/* Tabs Navigation */}
          <Tabs value={currentTab} onValueChange={(v) => handleTabChange(v as TabType)}>
