    ...
    <Card className={cn("border-border/50 shadow-sm", className)}>
      ...
      <CardContent className="space-y-5">
        ...
        <div className="p-4 rounded-lg bg-destructive/5 border border-destructive/20">
          <p className="text-sm text-muted-foreground mb-1">Total em Atraso</p>
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <div className="flex-1 p-3 rounded-lg bg-warning/10 border border-warning/20 text-center">
                ...
                <p className="text-[10px] text-muted-foreground">0-30 dias</p>
              </div>
              <div className="flex-1 p-3 rounded-lg bg-orange-500/10 border border-orange-500/20 text-center">
                ...
                <p className="text-[10px] text-muted-foreground">31-60 dias</p>
              </div>
