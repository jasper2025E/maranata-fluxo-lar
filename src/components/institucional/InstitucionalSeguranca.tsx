      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative bg-card rounded-3xl p-8 lg:p-12 border border-border/50 shadow-xl">
              ...
              <div className="flex justify-center mb-8">
                <div className="relative">
                  ...
                  <div className="relative w-24 h-24 rounded-full bg-gradient-to-br from-emerald-500 to-teal-500 flex items-center justify-center shadow-lg">
            ...
            {/* Decorative elements */}
            <div className="absolute -top-4 -right-4 w-24 h-24 bg-emerald-500/10 rounded-2xl -z-10 rotate-12" />
            <div className="absolute -bottom-4 -left-4 w-32 h-32 bg-teal-500/10 rounded-2xl -z-10 -rotate-12" />
          </motion.div>
        </div>
      </div>
    </section>
