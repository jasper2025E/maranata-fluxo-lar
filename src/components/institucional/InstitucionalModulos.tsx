...
const services = [
  ...
  },
  {
    icon: FlaskConical,
    title: "Ciências",
    description: "Explicações claras e experimentos simples para fixar o conteúdo.",
  },
  {
    icon: ClipboardCheck,
  ...
  },
  {
    icon: GraduationCap,
    title: "Alfabetização",
    description: "Método fônico com paciência e carinho para ler e escrever.",
  },
  {
    icon: Target,
    ...
    <section id="servicos" className="py-20 lg:py-28">
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="text-center mb-14">
          <p className="text-xs text-[#666] uppercase tracking-widest mb-3">Serviços</p>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {services.map((service, i) => {
            ...
            return (
              <div key={i} className="inst-card p-6">
