                  ...
                  {calculo && (
                    <Card>
                      ...
                      <CardContent className="grid grid-cols-2 gap-2 text-sm">
                        ...
                        <div className="text-right">{formatCurrency(calculo.salario_base)}</div>
                        <div>Total Bruto:</div>
                        <div className="text-right">{formatCurrency(calculo.total_bruto)}</div>
                        <div>INSS:</div>
                        <div className="text-right text-red-500">-{formatCurrency(calculo.inss)}</div>
                        <div>IRRF:</div>
                        <div className="text-right text-red-500">-{formatCurrency(calculo.irrf)}</div>
                        <div>FGTS (empresa):</div>
                        <div className="text-right text-muted-foreground">{formatCurrency(calculo.fgts)}</div>
                        <div className="font-bold pt-2 border-t">Total Líquido:</div>
                        <div className="text-right font-bold pt-2 border-t text-green-600">
            ...
            <TableBody>
              {folhas?.map((folha: any) => (
                <TableRow key={folha.id}>
                  ...
                  <TableCell>{folha.funcionarios?.cargos?.nome || "-"}</TableCell>
                  <TableCell>{formatCurrency(folha.salario_base)}</TableCell>
                  <TableCell>{formatCurrency(folha.total_bruto)}</TableCell>
                  ...
                  <TableCell>
                    <Badge variant={folha.pago ? "default" : "secondary"}>
