const fr = {
  translation: {
    ...
    invoices: {
      ...
      discounts: "Remises",
      delinquencyAging: "Ancienneté des Impayés",
      invoicesLower: "factures",
    ...
    responsibleDashboard: {
      ...
      activeResponsibles: "Responsables Actifs",
      ofRegistered: "sur {{count}} inscrits",
      toReceive: "À Recevoir",
      pendingInvoices: "{{count}} factures en attente",
      receivedThisMonth: "Reçu Ce Mois",
      ...
      quickActionsDesc: "Accédez aux fonctionnalités principales",
    },
  },
};
