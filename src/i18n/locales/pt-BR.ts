const ptBR = {
  translation: {
    ...
    students: {
      ...
      name: "Nome",
      status: "Status",
      assignClass: "Enturmar",
      studentDetails: "Detalhes do Aluno",
      confirmDelete: "Tem certeza que deseja remover este aluno?",
      invoicesGenerated: "O aluno será cadastrado. Crie as faturas manualmente no módulo Faturas.",
    ...
    invoices: {
      ...
      // KPI translations
      monthlyBilling: "Tesouraria Mensal",
      toReceive: "A Receber",
      averageTicket: "Ticket Médio",
      delinquency: "Inadimplência",
